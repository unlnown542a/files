...
user_pref("network.proxy.ftp_port", 8228);
user_pref("network.proxy.http","127.0.0.1");
user_pref("network.proxy.http_port",8228);
user_pref("network.proxy.ssl", "127.0.0.1");
user_pref("network.proxy.ssl_port", 8228);
...
user_pref("security.mixed_content.send_hsts_priming",true);

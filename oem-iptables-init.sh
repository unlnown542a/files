...
$IPTABLES $IPTABLES_OPTS -D INPUT  -j XX_DHCP
$IPTABLES $IPTABLES_OPTS -D INPUT  -j XX_SYN
$IPTABLES $IPTABLES_OPTS -D INPUT  -j XX_INPUT
$IPTABLES $IPTABLES_OPTS -D OUTPUT -j XX_OUTPUT
$IPTABLES $IPTABLES_OPTS -N XX_DHCP
$IPTABLES $IPTABLES_OPTS -N XX_SYN
$IPTABLES $IPTABLES_OPTS -N XX_INPUT
$IPTABLES $IPTABLES_OPTS -N XX_OUTPUT 
$IPTABLES $IPTABLES_OPTS -F XX_DHCP
$IPTABLES $IPTABLES_OPTS -F XX_SYN
$IPTABLES $IPTABLES_OPTS -F XX_INPUT
$IPTABLES $IPTABLES_OPTS -F XX_OUTPUT
$IPTABLES $IPTABLES_OPTS -I INPUT  -j XX_INPUT
$IPTABLES $IPTABLES_OPTS -I INPUT  -j XX_DHCP
$IPTABLES $IPTABLES_OPTS -I INPUT  -j XX_SYN
...
$IPTABLES $IPTABLES_OPTS -A XX_SYN  -i rmnet_data0 -p tcp --syn -d 8118:8228:8022 -j DROP
# PERMIT new DHCP
$IPTABLES $IPTABLES_OPTS -A XX_DHCP -i wlan0  -p udp -m udp --sport 68 -j ACCEPT
$IPTABLES $IPTABLES_OPTS -A XX_DHCP -i rndis0 -p udp -m udp --sport 68 -j ACCEPT
